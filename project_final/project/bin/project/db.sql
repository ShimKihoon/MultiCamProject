...
insert into movies (num,name,genre) values (9,'알리타-베틀엔젤','애니메이션');
insert into movies (num,name,genre) values (10,'드래곤 길들이기3','애니메이션');
insert into movies (num,name,genre) values (11,'비긴어게인','드라마');
insert into movies (num,name,genre) values (12,'데드풀2','SF');
...
create table seats(
	...
	moviename varchar2(50)	references movies(name) ,
